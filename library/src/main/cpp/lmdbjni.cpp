...
void throwLMDBError(JNIEnv *env, jint code) {
    if (code != MDB_SUCCESS) {
        ...
        jmethodID ctorMethod = env->GetMethodID(myExceptionClass, "<init>",
                                                "(Ljava/lang/String;I)V");
        jobject myExceptionObject = env->NewObject(myExceptionClass, ctorMethod,
                                                   env->NewStringUTF(message), code);
...
extern "C" JNIEXPORT void JNICALL
Java_com_openland_lmdb_LMDBJNI_openEnv(JNIEnv *env, jobject /* this */, jlong mdbEnvRaw,
                                       jstring pathRaw) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_openland_lmdb_LMDBJNI_beginTx(JNIEnv *env, jobject /* this */, jlong mdbEnvRaw,
                                       jboolean readonly) {
    MDB_env *mdbEnv = (MDB_env *) mdbEnvRaw;
    MDB_txn *transaction;
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_openland_lmdb_LMDBJNI_openDatabase(JNIEnv *env, jobject /* this */, jlong txnRaw,
                                            jstring nameRaw) {
    MDB_dbi dbi;
...
extern "C" JNIEXPORT void JNICALL
Java_com_openland_lmdb_LMDBJNI_put(JNIEnv *env, jobject /* this */, jlong txnRaw, jlong dbRaw,
                                   jstring keyRaw,
                                   jstring valueRaw) {
    MDB_val key, value;
...
Java_com_openland_lmdb_LMDBJNI_get(JNIEnv *env, jobject /* this */, jlong txnRaw, jlong dbRaw,
                                   jstring keyRaw) {
    MDB_val key, value;
